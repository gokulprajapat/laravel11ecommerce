                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                @foreach (explode(",",$product->images) as $gimage )
                                    <a href="details.html"><img loading="lazy" src="{{asset('/uploads/products/'.trim($gimage))}}" width="330" height="400" alt="{{$product->name}}" class="pc__img"></a>        
                                @endforeach
                    ...
                    <div class="pc__info position-relative">
                        ...
                        <span class="money price">
                            @if($product->sale_price)
                                <s>{{$product->sale_price}}</s>{{$product->regular_price}}
                            @endif
                        </span>
                        </div>
